...
namespace BootCamp2_6weekEnd.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        {
            var appDBContext = _context.CartItems.Include(c => c.Customer).Include(c => c.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,Quantity,CustomerId")] CartItem cartItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductId,Quantity,CustomerId")] CartItem cartItem)
        {
            if (id != cartItem.Id)
            {
                return NotFound();
